...
export default function Sidebar() {
    return (
        <>
            <aside
                className="fixed flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto border-r border-r-border-color">
                <h3 className="w-auto h-7 font-bold text-3xl text-center font-Montserrat">MY BLOG</h3>
                ...
                <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                    <svg className="w-5 h-5 text-gray-400" viewBox="0 0 24 24" fill="none">
                        <path
                            ...
                            <input type="text"
                                   className="w-full py-1.5 pl-10 pr-4 border border-border-color rounded-md bg-transparent focus:ring-1 focus:ring-opacity-40  focus:outline-none ring-[#555]"
                                   placeholder="Search"/>
                        </div>

                        <NavLink to="/"
                                 className={({ isActive }) =>
                                `flex items-center px-3 py-2 text-gray-400 transition-colors duration-300 transform rounded-lg hover:text-white hover:bg-border-color ${
                                     isActive ? "bg-border-color text-white" : null
                                }`
                        }>
                        ...
                        <NavLink to="/"
                                 className="flex items-center px-3 py-2 text-gray-400 transition-colors duration-300 transform rounded-lg hover:text-white hover:bg-border-color">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                 stroke="currentColor" className="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div className="mt-6">
                        <div className="p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
                            <h2 className="text-sm font-medium text-gray-800 dark:text-white">New feature
                                availabel!</h2>

                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet
                                consectetur adipisicing elit. Natus harum officia eligendi velit.</p>

                            <img className="object-cover w-full h-32 mt-2 rounded-lg"
